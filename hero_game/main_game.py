...
def monster_levelup(monster,hero):
    monster.monster_level = random.randint(hero.hero_level-1,hero.hero_level+1)
    print("the monster level is:",monster.monster_level)
    monster.constructor()
...
def main():
    ...
    monster_name = random.choice(["Brineclaw","Hauntmorph","Smokebody","Blightfang","The Infamous Ooze","The Grim Demon","The Black Tumor","The Golden Rot Lizard","The Dark Doom Freak","Voodoochild",])
    hero = Hero(hero_name)
